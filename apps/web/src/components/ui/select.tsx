...
function Select(props: NativeSelectProps | RadixSelectProps) {
  if (shouldUseNativeSelect(props)) {
    ...
    return (
      <select
        className={cn(
          "h-11 w-full rounded-2xl border border-line bg-white/90 px-4 text-sm text-ink outline-none transition focus:border-accent focus:ring-2 focus:ring-accent/15",
          className,
        )}
        {...nativeProps}
      >
